...
function mozilla_berlin_scripts() {
	...
	wp_enqueue_style( 'mozilla_berlin-style', get_stylesheet_uri() );
	
	wp_enqueue_script( 'mozilla_berlin-main-script', get_template_directory_uri() . '/assets/js/main.js', array( 'jquery' ), '20141005', true );
